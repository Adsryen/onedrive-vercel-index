...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'PT@jiss.cf',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Adsryen/onedrive-vercel-index',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/ryen_ads',
    },
  ],
